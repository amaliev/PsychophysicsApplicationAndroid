...
public class FayeClient {
    ...
    public FayeClient(String url, MetaMessage meta, Context context) {
        mServerUrl = url;
        mMetaMessage = meta;
    ...
    public void subscribeChannel(String channel) {
        mChannels.add(channel);
        SharedPreferences connection = mContext.getSharedPreferences("connection", 0);
    ...
    public String getClientId(){
        return mMetaMessage.getClientId();
    }
    ...
    private void openWebSocketConnection() {
        ...
        try {
            ...
            mWebSocket = new WebSocket(uri, mMessageHandler, mContext);
